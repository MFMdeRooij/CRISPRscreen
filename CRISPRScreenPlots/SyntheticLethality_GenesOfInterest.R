...
# This normalization can improve the comparison treated - control if the treated arm did not have equal cell divisions, however the separation between the essentials and non-essentials 
# will not be improved. Synthetic lethal genes will be on the lower half of the vertical 0 axis.
