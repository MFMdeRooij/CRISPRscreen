...
# Download "CRISPR (DepMap 22Q2 Public+Score, Chronos)" from https://depmap.org/portal/download/custom/, and include "Add cell line metadata to download"
...
for (gene in interestingGenes){
  ...
  if (gene %in% rownames(chronos)){
    pdf(paste0("CRISPRscores_",gene,".pdf"), width=10, height=20)
      i<-1
