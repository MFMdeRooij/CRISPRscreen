...
pairedEnd<-0
# Samples with paired-end and unpaired reads can be mapped together, but the count table generation should be run separately
...
# Search for RNAseq data on https://www.ncbi.nlm.nih.gov/sra/, and fill in the SRR codes, cell 
...
# This part you should run paired-end and unpaired samples separately
